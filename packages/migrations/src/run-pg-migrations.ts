...
import migration_2023_10_26T12_44_36_schema_checks_changes_index from './actions/2023.10.26T12.44.36.schema-checks-changes-index';
...
export const runPGMigrations = (args: { slonik: DatabasePool; runTo?: string }) =>
  runMigrations({
    ...
    migrations: [
      ...
      migration_2023_10_26T12_44_36_schema_checks_changes_index,
    ],
  });
