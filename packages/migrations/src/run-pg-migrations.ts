...
import migration_2024_09_26_create_preflight_scripts from './actions/2024.09.26T00.00.00.create-preflight-scripts';
...
export const runPGMigrations = (args: { slonik: DatabasePool; runTo?: string }) =>
  runMigrations({
    ...
    migrations: [
      ...
      migration_2024_09_26_create_preflight_scripts,
    ],
  });
