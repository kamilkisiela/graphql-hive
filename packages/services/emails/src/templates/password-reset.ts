export function renderPasswordResetEmail(params: { subject: string; passwordResetLink: string; toEmail: string }) {
  return `
<!doctype html>
																...
																<div style="padding-left: 15%; padding-right: 15%;">
																	...
																	<div class="button-td button-td-primary"
																		...
																		<a class="button-a button-a-primary"
																			href="${params.passwordResetLink}" target="_blank"
																...
																<div
																	...
																	<p
																		...
																		<a style="font-family: 'Helvetica', sans-serif, sans-serif; text-align: center; word-break: break-all; font-weight: 400; font-size: 14px; line-height: 23px; color: #007aff !important;"
																			target="_blank"
																			href="${params.passwordResetLink}">${params.passwordResetLink}</a>
																	</p>
																</div>
															</div>
