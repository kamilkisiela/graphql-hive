...
import type { CreateAccessToken_CreateTokenMutation } from '@/components/ui/modal/create-access-token';
import type { CreateOrganizationMutation } from '@/components/ui/modal/create-organization';
import type { CreateProjectMutation } from '@/components/ui/modal/create-project';
import type { CreateTarget_CreateTargetMutation } from '@/components/ui/modal/create-target';
import type { DeleteOrganizationDocument } from '@/components/ui/modal/delete-organization';
import { type DeleteProjectMutation } from '@/components/ui/modal/delete-project';
import { type DeleteTargetMutation } from '@/components/ui/modal/delete-target';
