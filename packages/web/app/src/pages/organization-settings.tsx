            ...
            <form onSubmit={nameForm.handleSubmit(onNameFormSubmit)}>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Changing the name of your organization will<span className="font-bold">not</span>{' '}
                    change the slug of your organization URL, and will{' '}
                    <span className="font-bold">not</span> invalidate any existing links to your
                    organization.
                    <br />
                    <DocsLink
