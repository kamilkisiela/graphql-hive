    ...
    <div className="flex">
      ...
      <div className="grow px-9 pt-11 pb-9">
        <div className="mx-auto flex w-[500px] flex-col">
          <HiveLink />
          <h2 className="mt-20 mb-1 text-2xl font-light text-white">{isLoginPage ? 'Log In' : 'Create an account'}</h2>
          <p className="font-light text-[#9b9b9b]">
            {isLoginPage ? "Don't Have An Account" : 'Already A Member'}?{' '}
            <Button variant="link" onClick={() => setLoginPage(prev => !prev)} className="font-light">
          ...
          <Link variant="primary" href="#" className={clsx('ml-auto mb-11', !isLoginPage && 'invisible')}>
            Forgot password?
          </Link>
          ...
          <p className="text-xs text-gray-800">
            This site is protected by reCAPTCHA and the Google Privacy Policy and Terms of Service apple
          </p>
        </div>
      </div>
    </div>
...
const GuildLink: FC<{ className?: string; textClassName?: string }> = ({ className, textClassName }) => (
  <a
  ...
  >
    <svg width="34" height="37" viewBox="0 0 34 37" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className={clsx('ml-2 flex gap-1', textClassName)}>
      <svg width="31" height="11" viewBox="0 0 31 11" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg width="47" height="11" viewBox="0 0 47 11" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
