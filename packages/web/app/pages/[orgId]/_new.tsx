...
const NewPage: FC = () => {
        ...
        return (
          <Container tw="pb-10">
            ...
            <p className="mb-10 text-center font-light text-gray-500">
              Create organization Lorem ipsum dolor sit amet, consectetur
              adipiscing elit. Turpis et dictum mattis tincidunt quis iaculis
      ...
      case 2:
        return (
          <Container tw="mt-8">
            ...
            <span className="mt-5 mb-2.5 text-xs font-bold">
              CHOOSE PROJECT TYPE
            </span>
          ...
          <Container tw="mt-16">
            ...
            <Card>
              ...
              <p className="text-sm text-gray-500">
                ...
                et dictum mattis tincidunt quis iaculis arcu proin suspendisse.
              </p>
            </Card>
          </Container>
        );
  ...
  return (
    <>
      <ShineBackground />
      <div
        className="wrapper relative flex h-full flex-col pt-5 pb-[155px]"
        ref={wrapperRef}
      >
        {[3, 4, 5].includes(page) && (
          <div className="absolute top-0 right-1/2 translate-x-1/2 rounded-b-[10px] border border-t-0 border-gray-800 px-2.5 py-7">
            <h1 className="text-center text-xs font-bold text-[#34eab9]">
              THE GUILD
            </h1>
      ...
      {[1, 2, 3, 4].includes(page) && (
        <div
          ...
          style={{ boxShadow: '0 -1px 0 #171a1f' }}
        >
