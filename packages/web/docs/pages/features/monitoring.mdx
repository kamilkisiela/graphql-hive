...
```bash
HIVE_TOKEN="your-token" HIVE_CDN_ENDPOINT="..." HIVE_CDN_KEY="..." ./router
```

> The `HIVE_CDN_*` environment variables are required to connect the router to the Schema Registry (Hive CDN).
