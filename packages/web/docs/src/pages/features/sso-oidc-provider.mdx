...
First we need to have a Microsoft Azure account, so you can register for a free account from
...
![](/docs/pages/features/sso-oidc-provider/azure-ad-configure-api-permissions.png)
![](/docs/pages/features/sso-oidc-provider/azure-ad-configure-api-permissions-graph.png)
![](/docs/pages/features/sso-oidc-provider/azure-ad-delegated-permissions.png)
...
<Callout type="info">
  ...
  ![](/docs/pages/features/sso-oidc-provider/azure-ad-users-tab.png)
  ![](/docs/pages/features/sso-oidc-provider/azure-ad-users-table.png)
  ![](/docs/pages/features/sso-oidc-provider/azure-ad-edit-user-properties.png)
  ![](/docs/pages/features/sso-oidc-provider/azure-ad-edit-user-email-field.png)
</Callout>
