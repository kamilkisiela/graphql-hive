...
[Target & Tokens](http://localhost:3000/management/targets#cdn-access-tokens)).
...
<Callout>
  ...
  page](/management/targets#revoking-a-cdn-access-token), and create a new token.
</Callout>
...
- [Integrating Hive CDN with Apollo Gateway](/integrations/apollo-gateway)
- [Integrating Hive CDN with Apollo Router](/integrations/apollo-router)
- [Get started with Hive and Apollo Fededation](/get-started/apollo-federation)
...
The [`@graphql-hive/client`](/api-reference/client#javascript--nodejs-client) package uses this
