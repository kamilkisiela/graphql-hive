...
import { Callout, Card, Cards, PackageCmd, Steps } from '@theguild/components'
...
<NextImage alt="Login/Signup view" src={signupImage} className="mt-10 max-w-sm drop-shadow-md" />
...
<NextImage
  ...
  src={orgImage}
  className="mt-10 max-w-lg drop-shadow-md"
/>
