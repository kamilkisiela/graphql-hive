...
export DOCKER_TAG=":latest" # Pin this to an exact commit hash from our `main` branch
...
choose what best suits your scenario. Then click `Create Project`, you're gonna be redirected to
your project page where you're gonna see 3 listed targets created for you by default:
...
Then create a `schema.graphql` file whenever you want, you can put it at the root for example with
...
Make sure you get a output specifiying the installed version for your CLI.
