...
<Tabs items={['One-click Deployment', 'Pre-built Docker Image', 'JavaScript Library']}>
  <Tab>
    ...
    <a target="_blank" href="https://heroku.com/deploy?template=https://github.com/dotansimha/graphql-hive-external-composition-heroku-template/tree/main">
      <img src="https://www.herokucdn.com/deploy/button.png" alt="One-click dpeloy to Heroku" />
    </a>
...
[Publish a GraphQL schema](/features/schema-registry#publish-a-schema) or perform a
[GraphQL schema check](/features/schema-registry#check-a-schema) to validate your setup.
