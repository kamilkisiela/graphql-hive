...
[create a CDN Access Token and gain access to the CDN endpoint](http://localhost:3000/features/high-availability-cdn#cdn-access-tokens).
...
- [Get started with Schema-Stitching and Hive guide](/get-started/schema-stitching)
