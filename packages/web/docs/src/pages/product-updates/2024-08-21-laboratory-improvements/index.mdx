...
In recent months we have worked on improving the Hive's laboratory, its new look and its new
...
<Caption>Old look of Operations collections plugin</Caption>

![New look of Operations collections plugin](./operations-collections-plugin-new.png)

<Caption>New look of Operations collections plugin</Caption>
...
The difference Hive's tabs from regular GraphiQL tabs is the better look, we were inspired by the UX
...
While adding this plugin in the laboratory, we discovered broken styles which we fixed
...
While working on improvements for the laboratory, we also cut the next major v4 alpha release of
...
<Caption>Vite migration attempts</Caption>
