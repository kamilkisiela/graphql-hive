...
[app deployments documentation](/docs/features/app-deployments).
...
decissions on deprecating and removing fields from your GraphQL API schema and avoid breaking
ancient versions of your app.
