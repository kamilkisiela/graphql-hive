...
Laboratory received support of official GraphiQL query builder plugin, named
[`@graphiql/plugin-explorer`](https://github.com/graphql/graphiql/tree/main/packages/graphiql-plugin-explorer).
While adding this plugin in laboratory, I discovered broken styles which I fixed
...
While working on improvements for laboratory, I also cut a next major v4 alpha release of GraphiQL,
which includes new tabs looks and migration from Webpack to Vite.
