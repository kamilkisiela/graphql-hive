...
[Get started with the CLI](/docs/gateway/introduction).
...
[Learn more about Hive Registry integration here](/docs/gateway/schema-registry/hive#publishing-subgraphs-to-hive-cdn)
...
[Learn more about GraphOS integration here](/docs/gateway/schema-registry/graphos)
