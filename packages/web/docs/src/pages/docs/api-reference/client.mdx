...
- [`@graphql-hive/core`](https://npmjs.com/package/@graphql-hive/core) - Core library for
  interacting with Hive's **Schema Registry** and **Usage Reporting**.
- [`@graphql-hive/yoga`](https://npmjs.com/package/@graphql-hive/yoga) - Integration with GraphQL
  Yoga.
- [`@graphql-hive/apollo`](https://npmjs.com/package/@graphql-hive/apollo) - Integration with Apollo
  Server.
- [`@graphql-hive/envelop`](https://npmjs.com/package/@graphql-hive/envelop) - Integration with
  Envelop.
...
Refer to the
[`HivePluginOptions` interface](https://github.com/kamilkisiela/graphql-hive/blob/main/packages/libraries/core/src/client/types.ts)
