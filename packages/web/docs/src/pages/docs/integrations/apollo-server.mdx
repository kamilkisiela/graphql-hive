...
you need to send the `x-client-name` and `x-client-version` HTTP headers for requests to the Apollo
Server instance from your client.
...
const serverCleanup = useServer(
  {
    ...
    execute: hiveClient.createInstrumentedSubscribe(subscribe),
