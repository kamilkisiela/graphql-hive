...
<Callout>
  ...
  Hive](/management/external-schema-composition).
</Callout>
...
[external composition service](/management/external-schema-composition). The difference is that
...
[You can read more about the process of configuring the external composition service in the your Hive instance here](/management/external-schema-composition#connect-to-hive)
