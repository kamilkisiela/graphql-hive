...
Now follow the instructions on [Project Management](/management/projects#channels) page to connect
between a Hive **project** and the actual Slack channel, and choose the alerts and notifications you
...
Now follow the instructions on [Project Management](/management/projects#github-repository) page to
connect between a Hive CLI and the GitHub repository.
...
Follow the instructions on the [SSO with OIDC guide](/management/sso-oidc-provider) for more
