...
By approving a breaking change, you are telling Hive that you are aware of the breaking change, and
want the breaking change approval is retained within the context of a pull/merge request or branch
lifecycle.
