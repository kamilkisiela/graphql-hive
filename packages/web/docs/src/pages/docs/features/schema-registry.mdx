...
<Cards>
  ...
  <Card arrow title="Schema-Stitching" href="/docs/self-hosting/schema-stitching" />
  <Card arrow title="Apollo Federation" href="/docs/self-hosting/apollo-federation" />
</Cards>
...
- [`schema:check` command reference](/docs/api-reference/cli#hive-schemacheck-file)
