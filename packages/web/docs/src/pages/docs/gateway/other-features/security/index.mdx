...
[Learn more how to configure persisted operations](/docs/gateway/features/performance/persisted-operations)
...
[Max Tokens Plugin](/docs/gateway/features/security/max-tokens).

Also this can be combined with [Character Limit](/docs/gateway/features/security/character-limit)
that limits the number of characters in the query and mutation documents.
...
You can use the [HMAC Signature plugin](/docs/gateway/features/security/hmac-signature) to perform
...
[Learn more about Max Depth plugin here](/docs/gateway/features/security/max-depth)
...
The [Rate Limit Plugin](/docs/gateway/features/security/rate-limiting) can be used to limit access
to resources by field level.
...
[Learn more about CORS plugin here](/docs/gateway/features/security/cors)
...
[Learn more about CSRF Prevention plugin here](/docs/gateway/features/security/csrf-prevention)
...
[Disable Introspection Plugin](/docs/gateway/features/security/disable-introspection) plugin solves
that in a single line of code!
...
[Block Field Suggestions Plugin](/docs/gateway/features/security/block-field-suggestions).
...
[Learn more about Error Masking](/docs/gateway/features/security/error-masking)
