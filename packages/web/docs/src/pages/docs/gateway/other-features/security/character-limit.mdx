...
<Callout>
  - We recommend using the [Max Tokens Plugin](/docs/gateway/features/security/max-tokens) instead
  of this one. - This plugin does not limit the size of input variables. - This plugin relies on a
