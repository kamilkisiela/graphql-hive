...
There is also [Execution Cancellation](/docs/gateway/features/performance/execution-cancellation)
that stops the execution, but it doesn't stop ongoing HTTP requests. This seperately allows you to
stop the HTTP requests by hooking into
