...
- [JSON Web Tokens (JWT)](/docs/gateway/features/auth/jwt): Hive Gateway provides a plugin to easily
  integrate JWT token verification into your API.
- [Generic Auth](/docs/gateway/features/auth/generic-auth): In some cases using a third party auth
...
- [Operation Field Permissions](/docs/gateway/features/auth/operation-field-permissions): You can
