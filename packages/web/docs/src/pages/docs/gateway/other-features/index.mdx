...
description: Hive Gateway have different features that extends the capabilities of your GraphQL API
...
[learn more here](/docs/gateway/features/custom-plugins).
