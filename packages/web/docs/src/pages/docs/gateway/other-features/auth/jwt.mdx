...
[Operation Field Permissions](/docs/gateway/other-features/security/auth/operation-field-permissions),
you can use the `jwt` property of the context to access the decoded JWT token, and decide what
...
[Generic Auth plugin](/docs/gateway/other-features/auth/generic-auth) to have a granular protection
using with or without JWT.
...
[Learn more about granular protection of Generic Auth plugin](/docs/gateway/other-features/auth/generic-auth)
