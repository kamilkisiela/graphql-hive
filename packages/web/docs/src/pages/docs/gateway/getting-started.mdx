...
In addition, you can also provide CLI parameters these via the configuration file.

The recommended language for the configuration file is TypeScript. The same configuration we
provided using the CLI, can be provided via the configuration file instead.
