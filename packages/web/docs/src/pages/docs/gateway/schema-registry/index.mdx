...
<Cards>
  <Cards.Card arrow title="Hive Registry" href="/docs/gateway/schema-registry/hive" />
  <Cards.Card arrow title="Apollo GraphOS" href="/docs/gateway/schema-registry/graphos" />
</Cards>
...
Refer to the [custom plugins docs](/docs/gateway/features/custom-plugins) for more information.
