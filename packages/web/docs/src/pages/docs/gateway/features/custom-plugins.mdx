...
You can see [Prometheus plugin](/docs/gateway/plugins/monitoring-tracing/prometheus) for an example
...
- [Prometheus plugin](/docs/gateway/plugins/monitoring-tracing/prometheus)
