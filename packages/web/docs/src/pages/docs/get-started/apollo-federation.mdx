...
[We have a guide on how to do this here](/management/external-schema-composition).**
...
<Cards>
  <Card arrow title="Apollo Gateway (JS)" href="/integrations/apollo-gateway" />
  <Card arrow title="Apollo Router (Rust)" href="/integrations/apollo-router" />
</Cards>
...
- [External Schema Compostion for Apollo Federation v2](/management/external-schema-composition)
- [Usage Reporting and Monintoring](/features/usage-reporting)
- [Conditional Breaking Changes](/features/conditional-breaking-changes)
- [Alerts and Notifications](/features/alerts-and-notifications)
- [CI/CD Integration](/features/ci-integration)
