...
As part of [Hive Client](/api-reference/client#javascript--nodejs-client) library, we are also
...
- [Schema Stitching Integration with Hive](/integrations/schema-stitching)
