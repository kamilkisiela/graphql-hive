...
export function deployUsageIngestor({
  ...
  const clickhouseEnv = {
    ...
    CLICKHOUSE_ASYNC_INSERT_BUSY_TIMEOUT_MS: 30_000, // flush data after max 30 seconds
    CLICKHOUSE_ASYNC_INSERT_MAX_DATA_SIZE: 200_000_000, // flush data when the buffer reaches 200MB
